...
namespace sg {
    public class boss_Gurd_sword_DamageCollider : DamageCollider
    {
        [SerializeField] AI_characterManager ai_Boss_Gurd_character;

        protected override void Awake()
        {
            base.Awake();
            damagecollider = GetComponent<Collider>();
            ai_Boss_Gurd_character = GetComponentInParent<AI_boss_manager>();
        }
